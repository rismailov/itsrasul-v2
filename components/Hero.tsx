            ...
            <div className="flex flex-col items-center sm:items-start">
                ...
                <div className="mt-3 max-w-2xl">
                    <p className="text-muted-foreground text-lg text-center sm:text-left">
                        ...
                        full-fledged CRM systems, I&apos;ve helped clients from
                        all over the world to achieve their goals.
                    </p>
                </div>
            ...
            <div className="flex-1 flex justify-center sm:justify-end">
                <div className="relative w-56 h-56">
                    <Image
                        ...
                        fill
                        sizes="33vw"
                        className="rounded-full object-center object-cover grayscale bg-secondary dark:bg-secondary/30"
                        priority
                    />
                </div>
            </div>
